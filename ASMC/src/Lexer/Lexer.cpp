...
Lexer::Lexer()
{
	...
	instruction_table = 
	{
		...
		{ "mov", "b", REGISTER, NUMBER,          3 }, { "mov", "b", PTR_IN_REGISTER, NUMBER,          3 }, { "mov", "b", PTR_IN_NUMBER, NUMBER,          4 }, /**/ { "add", "b", REGISTER, NUMBER,          3 }, { "add", "b", PTR_IN_REGISTER, NUMBER,          3 }, { "add", "b", PTR_IN_NUMBER, NUMBER,          4 }, /**/ { "sub", "b", REGISTER, NUMBER,          3 }, { "sub", "b", PTR_IN_REGISTER, NUMBER,          3 }, { "sub", "b", PTR_IN_NUMBER, NUMBER,          4 }, { "err", "", NOARG, NOARG, 1},            { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "nop", "", NOARG, NOARG, 1},
		{ "mov", "b", REGISTER, REGISTER,        3 }, { "mov", "b", PTR_IN_REGISTER, REGISTER,        3 }, { "mov", "b", PTR_IN_NUMBER, REGISTER,        4 }, /**/ { "add", "b", REGISTER, REGISTER,        3 }, { "add", "b", PTR_IN_REGISTER, REGISTER,        3 }, { "add", "b", PTR_IN_NUMBER, REGISTER,        4 }, /**/ { "sub", "b", REGISTER, REGISTER,        3 }, { "sub", "b", PTR_IN_REGISTER, REGISTER,        3 }, { "sub", "b", PTR_IN_NUMBER, REGISTER,        4 }, { "err", "", NOARG, NOARG, 1},            { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1},
		{ "mov", "b", REGISTER, PTR_IN_NUMBER,   4 }, { "mov", "b", PTR_IN_REGISTER, PTR_IN_NUMBER,   4 }, { "mov", "b", PTR_IN_NUMBER, PTR_IN_NUMBER,   5 }, /**/ { "add", "b", REGISTER, PTR_IN_NUMBER,   4 }, { "add", "b", PTR_IN_REGISTER, PTR_IN_NUMBER,   4 }, { "add", "b", PTR_IN_NUMBER, PTR_IN_NUMBER,   5 }, /**/ { "sub", "b", REGISTER, PTR_IN_NUMBER,   4 }, { "sub", "b", PTR_IN_REGISTER, PTR_IN_NUMBER,   4 }, { "sub", "b", PTR_IN_NUMBER, PTR_IN_NUMBER,   5 }, { "err", "", NOARG, NOARG, 1},            { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1},
		{ "mov", "b", REGISTER, PTR_IN_REGISTER, 3 }, { "mov", "b", PTR_IN_REGISTER, PTR_IN_REGISTER, 3 }, { "mov", "b", PTR_IN_NUMBER, PTR_IN_REGISTER, 4 }, /**/ { "add", "b", REGISTER, PTR_IN_REGISTER, 3 }, { "add", "b", PTR_IN_REGISTER, PTR_IN_REGISTER, 3 }, { "add", "b", PTR_IN_NUMBER, PTR_IN_REGISTER, 4 }, /**/ { "sub", "b", REGISTER, PTR_IN_REGISTER, 3 }, { "sub", "b", PTR_IN_REGISTER, PTR_IN_REGISTER, 3 }, { "sub", "b", PTR_IN_NUMBER, PTR_IN_REGISTER, 4 }, { "err", "", NOARG, NOARG, 1},            { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1},
																																																																																								   													  			   																					           															   
		{ "mov", "w", REGISTER, NUMBER,          4 }, { "mov", "w", PTR_IN_REGISTER, NUMBER,          4 }, { "mov", "w", PTR_IN_NUMBER, NUMBER,          5 }, /**/ { "add", "w", REGISTER, NUMBER,          4 }, { "add", "w", PTR_IN_REGISTER, NUMBER,          4 }, { "add", "w", PTR_IN_NUMBER, NUMBER,          5 }, /**/ { "sub", "w", REGISTER, NUMBER,          4 }, { "sub", "w", PTR_IN_REGISTER, NUMBER,          4 }, { "sub", "w", PTR_IN_NUMBER, NUMBER,          5 }, { "err", "", NOARG, NOARG, 1},            { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1},
		{ "mov", "w", REGISTER, REGISTER,        3 }, { "mov", "w", PTR_IN_REGISTER, REGISTER,        3 }, { "mov", "w", PTR_IN_NUMBER, REGISTER,        4 }, /**/ { "add", "w", REGISTER, REGISTER,        3 }, { "add", "w", PTR_IN_REGISTER, REGISTER,        3 }, { "add", "w", PTR_IN_NUMBER, REGISTER,        4 }, /**/ { "sub", "w", REGISTER, REGISTER,        3 }, { "sub", "w", PTR_IN_REGISTER, REGISTER,        3 }, { "sub", "w", PTR_IN_NUMBER, REGISTER,        4 }, { "err", "", NOARG, NOARG, 1},            { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1},
		{ "mov", "w", REGISTER, PTR_IN_NUMBER,   4 }, { "mov", "w", PTR_IN_REGISTER, PTR_IN_NUMBER,   4 }, { "mov", "w", PTR_IN_NUMBER, PTR_IN_NUMBER,   5 }, /**/ { "add", "w", REGISTER, PTR_IN_NUMBER,   4 }, { "add", "w", PTR_IN_REGISTER, PTR_IN_NUMBER,   4 }, { "add", "w", PTR_IN_NUMBER, PTR_IN_NUMBER,   5 }, /**/ { "sub", "w", REGISTER, PTR_IN_NUMBER,   4 }, { "sub", "w", PTR_IN_REGISTER, PTR_IN_NUMBER,   4 }, { "sub", "w", PTR_IN_NUMBER, PTR_IN_NUMBER,   5 }, { "err", "", NOARG, NOARG, 1},            { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1},
		...
		{ "cmp", "b", REGISTER, NUMBER,          3 }, { "cmp", "b", PTR_IN_REGISTER, NUMBER,          3 }, { "cmp", "b", PTR_IN_NUMBER, NUMBER,          4 },      { "err", "", NOARG, NOARG, 1},                { "err", "", NOARG, NOARG, 1},                       { "err", "", NOARG, NOARG, 1},                          { "err", "", NOARG, NOARG, 1},                { "err", "", NOARG, NOARG, 1},                       { "err", "", NOARG, NOARG, 1},                     { "err", "", NOARG, NOARG, 1},            { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1},
		{ "cmp", "b", REGISTER, REGISTER,        3 }, { "cmp", "b", PTR_IN_REGISTER, REGISTER,        3 }, { "cmp", "b", PTR_IN_NUMBER, REGISTER,        4 },      { "err", "", NOARG, NOARG, 1},                { "err", "", NOARG, NOARG, 1},                       { "err", "", NOARG, NOARG, 1},                          { "err", "", NOARG, NOARG, 1},                { "err", "", NOARG, NOARG, 1},                       { "err", "", NOARG, NOARG, 1},                     { "err", "", NOARG, NOARG, 1},            { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1},
		{ "cmp", "b", REGISTER, PTR_IN_NUMBER,   4 }, { "cmp", "b", PTR_IN_REGISTER, PTR_IN_NUMBER,   4 }, { "cmp", "b", PTR_IN_NUMBER, PTR_IN_NUMBER,   5 },      { "err", "", NOARG, NOARG, 1},                { "err", "", NOARG, NOARG, 1},                       { "err", "", NOARG, NOARG, 1},                          { "err", "", NOARG, NOARG, 1},                { "err", "", NOARG, NOARG, 1},                       { "err", "", NOARG, NOARG, 1},                     { "err", "", NOARG, NOARG, 1},            { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "hlt", "", NOARG, NOARG, 1},
		{ "cmp", "b", REGISTER, PTR_IN_REGISTER, 3 }, { "cmp", "b", PTR_IN_REGISTER, PTR_IN_REGISTER, 3 }, { "cmp", "b", PTR_IN_NUMBER, PTR_IN_REGISTER, 4 },      { "err", "", NOARG, NOARG, 1},                { "err", "", NOARG, NOARG, 1},                       { "err", "", NOARG, NOARG, 1},                          { "err", "", NOARG, NOARG, 1},                { "err", "", NOARG, NOARG, 1},                       { "err", "", NOARG, NOARG, 1},                     { "err", "", NOARG, NOARG, 1},            { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1},
