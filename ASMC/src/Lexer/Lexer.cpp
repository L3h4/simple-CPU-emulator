...
Lexer::Lexer()
{
	...
	instruction_table = 
	{
		...
		{ "cmp", "b", REGISTER, PTR_IN_REGISTER, 3 }, { "cmp", "b", PTR_IN_REGISTER, PTR_IN_REGISTER, 3 }, { "cmp", "b", PTR_IN_NUMBER, PTR_IN_REGISTER, 4 },      { "err", "", NOARG, NOARG, 1},                { "err", "", NOARG, NOARG, 1},                       { "err", "", NOARG, NOARG, 1},                          { "err", "", NOARG, NOARG, 1},                { "err", "", NOARG, NOARG, 1},                       { "err", "", NOARG, NOARG, 1},                     { "call", "", PTR_IN_REGISTER, NOARG, 2 },   { "err", "", NOARG, NOARG, 1},             { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1}, { "err", "", NOARG, NOARG, 1},
