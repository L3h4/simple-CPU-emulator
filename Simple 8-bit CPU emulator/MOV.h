...
void Ox64cmCPU::MOV()
{
	if (arg1.type == REGISTER)
	{
		...
		else if (arg2.type == REGISTERPTR)
		{
			arg1.reg->lo = *bus->read(arg2.reg->value);
		}
	...
	else if (arg1.type == REGISTER16)
	{
		...
		else if (arg2.type == REGISTERPTR16)
		{
			arg1.reg->value = (*bus->read(arg2.reg->value) << 8) + *bus->read(arg2.reg->value + 1);
		}
	...
	else if (arg1.type == REGISTERPTR)
	{
		if (arg2.type == IMMDATA)
		{
			bus->write(arg1.reg->value, arg2.value);
		}
		else if (arg2.type == REGISTER)
		{
			bus->write(arg1.reg->value, arg2.reg->lo);
		}
		else if (arg2.type == REGISTERPTR)
		{
			bus->write(arg1.reg->value, *bus->read(arg2.reg->value));
		}
		else if (arg2.type == ADDRESS)
		{
			bus->write(arg1.reg->value, *bus->read(arg2.address));
		}
		else
		{
			throw "Unknown data source";
	...
	else if (arg1.type == REGISTERPTR16)
	{
		if (arg2.type == IMMDATA16)
		{
			bus->write(arg1.reg->value, arg2.value16 >> 8);
			bus->write(arg1.reg->value + 1, arg2.value16);
		}
		else if (arg2.type == REGISTER16)
		{
			bus->write(arg1.reg->value, arg2.reg->value >> 8);
			bus->write(arg1.reg->value + 1, arg2.reg->value);
		}
		else if (arg2.type == REGISTERPTR16)
		{
			bus->write(arg1.reg->value, *bus->read(arg2.reg->value));
			bus->write(arg1.reg->value + 1, *bus->read(arg2.reg->value + 1));
		}
		else if (arg2.type == ADDRESS16)
		{
			bus->write(arg1.reg->value, *bus->read(arg2.address));
			bus->write(arg1.reg->value + 1, *bus->read(arg2.address + 1));
		}
		else
		{
			throw "Unknown data source";
	...
	else if (arg1.type == ADDRESS)
	{
		...
		{
			bus->write(arg1.address, *bus->read(arg2.reg->value));
		}
		else if (arg2.type == ADDRESS)
		{
	...
	else if (arg1.type == ADDRESS16)
	{
		...
		{
			bus->write(arg1.address, *bus->read(arg2.reg->value));
			bus->write(arg1.address + 1, *bus->read(arg2.reg->value + 1));
		}
		else if (arg2.type == ADDRESS16)
		{
			bus->write(arg1.address, *bus->read(arg2.address));
